...
# Drug + dose only (no T-cell treatment)
cell_data$drug_dose <- paste(cell_data$Drug, cell_data$Dose, sep="_")
colData(cds)$drug_dose <- factor(cell_data$drug_dose)
```
...
qc_dir <- file.path(outdir, "QC_summaries")
...
# Figure: UMAP by Drug
plot_cells(cds, color_cells_by = "Drug", cell_size = 0.2) +
  scale_color_brewer(palette = "Set3") +
  theme_void() +
  theme(legend.position = "right",
        legend.key.width = unit(0.2, "line"),
        legend.key.height = unit(0.2, "line"))
ggsave(file.path(outdir, "umap_drug.png"), dpi = 600, width = 4, height = 2.3)
ggsave(file.path(outdir, "umap_drug.pdf"), dpi = 600, width = 4, height = 2.3)
ggsave(file.path(outdir, "umap_drug.svg"), dpi = 600, width = 4, height = 2.3)

# Figure: UMAP by Dose
plot_cells(cds, color_cells_by = "Dose", cell_size = 0.2) +
  scale_color_brewer(palette = "Set2") +
  theme_void() +
  theme(legend.position = "right",
        legend.key.width = unit(0.2, "line"),
        legend.key.height = unit(0.2, "line"))
ggsave(file.path(outdir, "umap_dose.png"), dpi = 600, width = 3, height = 1.5)
ggsave(file.path(outdir, "umap_dose.pdf"), dpi = 600, width = 3, height = 1.5)
ggsave(file.path(outdir, "umap_dose.svg"), dpi = 600, width = 3, height = 1.5)
