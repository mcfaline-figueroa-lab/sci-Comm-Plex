...
dose_avg <- data.frame(
  NoT = rowMeans(expr_data[, sample_info$Tcell_Treatment == "NoT"], na.rm = TRUE),
  T_0.5 = rowMeans(expr_data[, sample_info$Tcell_Treatment == "0.5T"], na.rm = TRUE)
)
...
pheatmap(
  ...
  cluster_cols = TRUE,
  cluster_rows = FALSE,
  main = "Top 30 Dose-Response Genes",
