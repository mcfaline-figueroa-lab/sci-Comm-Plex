...
ggsave(file.path(output_dir, "DEG_testing/dotplot_go_results.png"), plot = p, width = 6, height = 22, dpi = 300)
ggsave(file.path(output_dir, "DEG_testing/dotplot_go_results.pdf"), plot = p, width = 6, height = 22, dpi = 300)
```
