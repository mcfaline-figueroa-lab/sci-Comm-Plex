...
output_dir <- "CRISPRI_Figures/NTC_analysis"
...
```{r}
saveRDS(Tcell_dose_response_diff_test, file.path(output_dir, "DEG_testing/NTC_CRISPRI_dose_response_diff_test_20250520_replicates_ori.rds"))
```
